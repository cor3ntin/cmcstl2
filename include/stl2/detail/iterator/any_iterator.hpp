...
STL2_OPEN_NAMESPACE {
	namespace __any_iterator {
		...
		ReadableIterator{I} struct shared_iterator : counted {
		...
		template <class Reference, ReadableIterator I>
		...
		template <class RValueReference, ReadableIterator I>
		...
		public:
			...
			public:
				mixin() = default;
				ReadableIterator{I} explicit mixin(I i)
